    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", maxWidth: 640, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.8rem,5.5vw,2.8rem)", fontWeight: 700, lineHeight: 1.2, background: "linear-gradient(90deg,#4f6ef7 0%,#7c3aed 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: 20, letterSpacing: "0em", fontFamily: "'Poppins', sans-serif" }}>
            No Watermark
          </h1>
