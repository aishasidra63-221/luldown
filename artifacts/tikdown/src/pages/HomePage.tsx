    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", maxWidth: 640, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.8rem,5.5vw,2.8rem)", fontWeight: 700, lineHeight: 1.2, background: "linear-gradient(90deg, #7c3aed 0%, #4f6ef7 50%, #06b6d4 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", WebkitTextStroke: "1.5px rgba(255,255,255,0.85)", marginBottom: 8, letterSpacing: "-0.01em" }}>
            No Watermark
          </h1>
